...
public final class ManagedInstanceLongTermRetentionPoliciesInner {
     ...
     */
    public ManagedInstanceLongTermRetentionPoliciesInner(SqlManagementClientImpl client) {
    ...
    public Mono<ManagedInstanceLongTermRetentionPolicyInner> createOrUpdateAsync(String resourceGroupName, String managedInstanceName, String databaseName, ManagedInstanceLongTermRetentionPolicyInner parameters) {
        ...
        return this.client.<ManagedInstanceLongTermRetentionPolicyInner, ManagedInstanceLongTermRetentionPolicyInner>getLroResultAsync(response, this.client.getHttpPipeline(), ManagedInstanceLongTermRetentionPolicyInner.class, ManagedInstanceLongTermRetentionPolicyInner.class)
            .last()
