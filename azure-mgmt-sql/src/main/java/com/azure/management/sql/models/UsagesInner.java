...
public final class UsagesInner {
     ...
     */
    public UsagesInner(SqlManagementClientImpl client) {
    ...
    public Mono<PagedResponse<UsageInner>> listByInstancePoolSinglePageAsync(String resourceGroupName, String instancePoolName, Boolean expandChildren) {
        ...
        return service.listByInstancePool(this.client.getHost(), resourceGroupName, instancePoolName, expandChildren, this.client.getSubscriptionId(), apiVersion).map(res -> new PagedResponseBase<>(
            res.getRequest(),
            res.getStatusCode(),
            res.getHeaders(),
            res.getValue().value(),
