...
public class FlowLogInner extends Resource {
    ...
    /**
     * Get the targetResourceId property: ID of network security group to which
    ...
    /**
     * Set the targetResourceId property: ID of network security group to which
     * flow log will be applied.
     * 
    ...
    /**
     * Get the targetResourceGuid property: Guid of network security group to
