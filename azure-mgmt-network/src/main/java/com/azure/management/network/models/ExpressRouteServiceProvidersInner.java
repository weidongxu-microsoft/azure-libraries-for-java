...
public final class ExpressRouteServiceProvidersInner {
     ...
     * NetworkManagementClientExpressRouteServiceProviders to be used by the
    ...
    private interface ExpressRouteServiceProvidersService {
        ...
        Mono<SimpleResponse<ExpressRouteServiceProviderListResultInner>> list(@HostParam("$host") String host, @PathParam("subscriptionId") String subscriptionId, @QueryParam("api-version") String apiVersion);

        @Get("{nextLink}")
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(CloudException.class)
        Mono<SimpleResponse<ExpressRouteServiceProviderListResultInner>> listNext(@PathParam(value = "nextLink", encoded = true) String nextLink);
    }
