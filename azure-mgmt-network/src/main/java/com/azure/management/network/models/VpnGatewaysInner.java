...
public final class VpnGatewaysInner implements InnerSupportsGet<VpnGatewayInner>, InnerSupportsListing<VpnGatewayInner>, InnerSupportsDelete<Void> {
    ...
    private interface VpnGatewaysService {
        ...
        Mono<SimpleResponse<Flux<ByteBuffer>>> reset(@HostParam("$host") String host, @PathParam("resourceGroupName") String resourceGroupName, @PathParam("gatewayName") String gatewayName, @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId);
        ...
        @ExpectedResponses({200, 202})
        @UnexpectedResponseExceptionType(CloudException.class)
        Mono<SimpleResponse<VpnGatewayInner>> beginReset(@HostParam("$host") String host, @PathParam("resourceGroupName") String resourceGroupName, @PathParam("gatewayName") String gatewayName, @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId);
    ...
    public Mono<SimpleResponse<Flux<ByteBuffer>>> createOrUpdateWithResponseAsync(String resourceGroupName, String gatewayName, VpnGatewayInner vpnGatewayParameters) {
        final String apiVersion = "2019-06-01";
        return service.createOrUpdate(this.client.getHost(), this.client.getSubscriptionId(), resourceGroupName, gatewayName, apiVersion, vpnGatewayParameters);
    }
    ...
    public Mono<VpnGatewayInner> createOrUpdateAsync(String resourceGroupName, String gatewayName, VpnGatewayInner vpnGatewayParameters) {
        ...
        return this.client.<VpnGatewayInner, VpnGatewayInner>getLroResultAsync(response, this.client.getHttpPipeline(), VpnGatewayInner.class, VpnGatewayInner.class)
            .last()
    ...
    public Mono<SimpleResponse<Flux<ByteBuffer>>> updateTagsWithResponseAsync(String resourceGroupName, String gatewayName, Map<String, String> tags) {
        ...
        return service.updateTags(this.client.getHost(), this.client.getSubscriptionId(), resourceGroupName, gatewayName, apiVersion, vpnGatewayParameters);
    }
    ...
    public Mono<SimpleResponse<Flux<ByteBuffer>>> resetWithResponseAsync(String resourceGroupName, String gatewayName) {
        final String apiVersion = "2019-06-01";
        return service.reset(this.client.getHost(), resourceGroupName, gatewayName, apiVersion, this.client.getSubscriptionId());
    }
    ...
    public Mono<SimpleResponse<VpnGatewayInner>> beginCreateOrUpdateWithResponseAsync(String resourceGroupName, String gatewayName, VpnGatewayInner vpnGatewayParameters) {
        final String apiVersion = "2019-06-01";
        return service.beginCreateOrUpdate(this.client.getHost(), this.client.getSubscriptionId(), resourceGroupName, gatewayName, apiVersion, vpnGatewayParameters);
    }
    ...
    public Mono<SimpleResponse<VpnGatewayInner>> beginUpdateTagsWithResponseAsync(String resourceGroupName, String gatewayName, Map<String, String> tags) {
        ...
        TagsObject vpnGatewayParameters = new TagsObject();
        vpnGatewayParameters.withTags(tags);
        return service.beginUpdateTags(this.client.getHost(), this.client.getSubscriptionId(), resourceGroupName, gatewayName, apiVersion, vpnGatewayParameters);
    }
    ...
    public Mono<SimpleResponse<VpnGatewayInner>> beginResetWithResponseAsync(String resourceGroupName, String gatewayName) {
        final String apiVersion = "2019-06-01";
        return service.beginReset(this.client.getHost(), resourceGroupName, gatewayName, apiVersion, this.client.getSubscriptionId());
    }
