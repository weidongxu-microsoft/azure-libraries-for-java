...
public final class VirtualWanVpnProfileParameters {
    ...
    /**
     * Get the vpnServerConfigurationResourceId property:
     * VpnServerConfiguration partial resource uri with which VirtualWan is
     * associated to.
     * 
    ...
    /**
     * Set the vpnServerConfigurationResourceId property:
     * VpnServerConfiguration partial resource uri with which VirtualWan is
     * associated to.
     * 
     * @param vpnServerConfigurationResourceId the
     * vpnServerConfigurationResourceId value to set.
