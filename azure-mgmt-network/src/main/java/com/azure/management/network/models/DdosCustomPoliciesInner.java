...
public final class DdosCustomPoliciesInner implements InnerSupportsGet<DdosCustomPolicyInner>, InnerSupportsDelete<Void> {
    ...
    private interface DdosCustomPoliciesService {
        ...
        Mono<SimpleResponse<Flux<ByteBuffer>>> delete(@HostParam("$host") String host, @PathParam("resourceGroupName") String resourceGroupName, @PathParam("ddosCustomPolicyName") String ddosCustomPolicyName, @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId);
        ...
        @UnexpectedResponseExceptionType(CloudException.class)
        Mono<SimpleResponse<DdosCustomPolicyInner>> getByResourceGroup(@HostParam("$host") String host, @PathParam("resourceGroupName") String resourceGroupName, @PathParam("ddosCustomPolicyName") String ddosCustomPolicyName, @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId);
        ...
        @ExpectedResponses({200, 202, 204})
        @UnexpectedResponseExceptionType(CloudException.class)
        Mono<Response<Void>> beginDelete(@HostParam("$host") String host, @PathParam("resourceGroupName") String resourceGroupName, @PathParam("ddosCustomPolicyName") String ddosCustomPolicyName, @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId);
    ...
    public Mono<SimpleResponse<Flux<ByteBuffer>>> deleteWithResponseAsync(String resourceGroupName, String ddosCustomPolicyName) {
        ...
        return service.delete(this.client.getHost(), resourceGroupName, ddosCustomPolicyName, apiVersion, this.client.getSubscriptionId());
    }
    ...
    public Mono<SimpleResponse<DdosCustomPolicyInner>> getByResourceGroupWithResponseAsync(String resourceGroupName, String ddosCustomPolicyName) {
        final String apiVersion = "2019-06-01";
        return service.getByResourceGroup(this.client.getHost(), resourceGroupName, ddosCustomPolicyName, apiVersion, this.client.getSubscriptionId());
    }
    ...
    public Mono<SimpleResponse<Flux<ByteBuffer>>> createOrUpdateWithResponseAsync(String resourceGroupName, String ddosCustomPolicyName, DdosCustomPolicyInner parameters) {
        final String apiVersion = "2019-06-01";
        return service.createOrUpdate(this.client.getHost(), resourceGroupName, ddosCustomPolicyName, apiVersion, this.client.getSubscriptionId(), parameters);
    }
    ...
    public Mono<DdosCustomPolicyInner> createOrUpdateAsync(String resourceGroupName, String ddosCustomPolicyName, DdosCustomPolicyInner parameters) {
        ...
        return this.client.<DdosCustomPolicyInner, DdosCustomPolicyInner>getLroResultAsync(response, this.client.getHttpPipeline(), DdosCustomPolicyInner.class, DdosCustomPolicyInner.class)
            .last()
            .flatMap(AsyncPollResponse::getFinalResult);
    }
    ...
    public Mono<SimpleResponse<Flux<ByteBuffer>>> updateTagsWithResponseAsync(String resourceGroupName, String ddosCustomPolicyName, Map<String, String> tags) {
        ...
        return service.updateTags(this.client.getHost(), resourceGroupName, ddosCustomPolicyName, apiVersion, this.client.getSubscriptionId(), parameters);
    }
    ...
    public Mono<Response<Void>> beginDeleteWithResponseAsync(String resourceGroupName, String ddosCustomPolicyName) {
        final String apiVersion = "2019-06-01";
        return service.beginDelete(this.client.getHost(), resourceGroupName, ddosCustomPolicyName, apiVersion, this.client.getSubscriptionId());
    }
    ...
    public Mono<SimpleResponse<DdosCustomPolicyInner>> beginCreateOrUpdateWithResponseAsync(String resourceGroupName, String ddosCustomPolicyName, DdosCustomPolicyInner parameters) {
        final String apiVersion = "2019-06-01";
        return service.beginCreateOrUpdate(this.client.getHost(), resourceGroupName, ddosCustomPolicyName, apiVersion, this.client.getSubscriptionId(), parameters);
    }
    ...
    public Mono<SimpleResponse<DdosCustomPolicyInner>> beginUpdateTagsWithResponseAsync(String resourceGroupName, String ddosCustomPolicyName, Map<String, String> tags) {
        ...
        TagsObject parameters = new TagsObject();
        parameters.withTags(tags);
        return service.beginUpdateTags(this.client.getHost(), resourceGroupName, ddosCustomPolicyName, apiVersion, this.client.getSubscriptionId(), parameters);
    }
