...
public final class ConnectionMonitorHttpConfiguration {
    ...
    /**
     * Get the path property: The path component of the URI. For instance,
     * "/dir1/dir2".
     * 
    ...
    /**
     * Set the path property: The path component of the URI. For instance,
     * "/dir1/dir2".
     * 
    ...
    /**
     * Get the requestHeaders property: The HTTP headers to transmit with the
     * request.
     * 
    ...
    /**
     * Set the requestHeaders property: The HTTP headers to transmit with the
     * request.
     * 
    ...
    /**
     * Get the validStatusCodeRanges property: HTTP status codes to consider
    ...
    /**
     * Set the validStatusCodeRanges property: HTTP status codes to consider
     * successful. For instance, "2xx,301-304,418".
     * 
    ...
    /**
     * Get the preferHttps property: Value indicating whether HTTPS is
     * preferred over HTTP in cases where the choice is not explicit.
     * 
    ...
    /**
     * Set the preferHttps property: Value indicating whether HTTPS is
     * preferred over HTTP in cases where the choice is not explicit.
     * 
