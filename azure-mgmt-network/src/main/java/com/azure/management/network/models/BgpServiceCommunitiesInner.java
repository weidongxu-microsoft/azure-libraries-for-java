...
public final class BgpServiceCommunitiesInner {
    ...
    private interface BgpServiceCommunitiesService {
        ...
        Mono<SimpleResponse<BgpServiceCommunityListResultInner>> list(@HostParam("$host") String host, @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId);
