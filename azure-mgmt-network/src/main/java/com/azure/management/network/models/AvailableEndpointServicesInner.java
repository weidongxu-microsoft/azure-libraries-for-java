...
public final class AvailableEndpointServicesInner {
     ...
     */
    @Host("{$host}")
    @ServiceInterface(name = "NetworkManagementClientAvailableEndpointServices")
    private interface AvailableEndpointServicesService {
        ...
        Mono<SimpleResponse<EndpointServicesListResultInner>> list(@HostParam("$host") String host, @PathParam("location") String location, @PathParam("subscriptionId") String subscriptionId, @QueryParam("api-version") String apiVersion);

        @Headers({ "Content-Type: application/json", "Accept: application/json" })
        @Get("{nextLink}")
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(CloudException.class)
        Mono<SimpleResponse<EndpointServicesListResultInner>> listNext(@PathParam(value = "nextLink", encoded = true) String nextLink);
    }
