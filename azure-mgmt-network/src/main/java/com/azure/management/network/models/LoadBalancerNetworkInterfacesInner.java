...
public final class LoadBalancerNetworkInterfacesInner {
    ...
    private interface LoadBalancerNetworkInterfacesService {
        ...
        Mono<SimpleResponse<NetworkInterfaceListResultInner>> list(@HostParam("$host") String host, @PathParam("resourceGroupName") String resourceGroupName, @PathParam("loadBalancerName") String loadBalancerName, @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId);
