...
public final class AvailablePrivateEndpointTypesInner {
    ...
    private interface AvailablePrivateEndpointTypesService {
        ...
        Mono<SimpleResponse<AvailablePrivateEndpointTypesResultInner>> list(@HostParam("$host") String host, @PathParam("location") String location, @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId);
