...
public final class AzureFirewallFqdnTagsInner {
    ...
    private interface AzureFirewallFqdnTagsService {
        ...
        Mono<SimpleResponse<AzureFirewallFqdnTagListResultInner>> list(@HostParam("$host") String host, @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId);
