...
public final class DdosProtectionPlansInner implements InnerSupportsGet<DdosProtectionPlanInner>, InnerSupportsListing<DdosProtectionPlanInner>, InnerSupportsDelete<Void> {
    ...
    private interface DdosProtectionPlansService {
        ...
        Mono<SimpleResponse<Flux<ByteBuffer>>> delete(@HostParam("$host") String host, @PathParam("resourceGroupName") String resourceGroupName, @PathParam("ddosProtectionPlanName") String ddosProtectionPlanName, @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId);
        ...
        @UnexpectedResponseExceptionType(CloudException.class)
        Mono<SimpleResponse<DdosProtectionPlanInner>> getByResourceGroup(@HostParam("$host") String host, @PathParam("resourceGroupName") String resourceGroupName, @PathParam("ddosProtectionPlanName") String ddosProtectionPlanName, @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId);
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(CloudException.class)
        Mono<SimpleResponse<DdosProtectionPlanListResultInner>> list(@HostParam("$host") String host, @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId);

        @Headers({ "Accept: application/json", "Content-Type: application/json" })
        @Get("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/ddosProtectionPlans")
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(CloudException.class)
        Mono<SimpleResponse<DdosProtectionPlanListResultInner>> listByResourceGroup(@HostParam("$host") String host, @PathParam("resourceGroupName") String resourceGroupName, @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId);

        @Headers({ "Accept: application/json;q=0.9", "Content-Type: application/json" })
        @Delete("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/ddosProtectionPlans/{ddosProtectionPlanName}")
        @ExpectedResponses({200, 202, 204})
        @UnexpectedResponseExceptionType(CloudException.class)
        Mono<Response<Void>> beginDelete(@HostParam("$host") String host, @PathParam("resourceGroupName") String resourceGroupName, @PathParam("ddosProtectionPlanName") String ddosProtectionPlanName, @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId);
    ...
    public Mono<SimpleResponse<Flux<ByteBuffer>>> deleteWithResponseAsync(String resourceGroupName, String ddosProtectionPlanName) {
        ...
        return service.delete(this.client.getHost(), resourceGroupName, ddosProtectionPlanName, apiVersion, this.client.getSubscriptionId());
    }
    ...
    public Mono<SimpleResponse<DdosProtectionPlanInner>> getByResourceGroupWithResponseAsync(String resourceGroupName, String ddosProtectionPlanName) {
        final String apiVersion = "2019-06-01";
        return service.getByResourceGroup(this.client.getHost(), resourceGroupName, ddosProtectionPlanName, apiVersion, this.client.getSubscriptionId());
    }
    ...
    public Mono<SimpleResponse<Flux<ByteBuffer>>> createOrUpdateWithResponseAsync(String resourceGroupName, String ddosProtectionPlanName, DdosProtectionPlanInner parameters) {
        final String apiVersion = "2019-06-01";
        return service.createOrUpdate(this.client.getHost(), resourceGroupName, ddosProtectionPlanName, apiVersion, this.client.getSubscriptionId(), parameters);
    }
    ...
    public Mono<DdosProtectionPlanInner> createOrUpdateAsync(String resourceGroupName, String ddosProtectionPlanName, DdosProtectionPlanInner parameters) {
        ...
        return this.client.<DdosProtectionPlanInner, DdosProtectionPlanInner>getLroResultAsync(response, this.client.getHttpPipeline(), DdosProtectionPlanInner.class, DdosProtectionPlanInner.class)
            .last()
            .flatMap(AsyncPollResponse::getFinalResult);
    }
    ...
    public Mono<SimpleResponse<Flux<ByteBuffer>>> updateTagsWithResponseAsync(String resourceGroupName, String ddosProtectionPlanName, Map<String, String> tags) {
        ...
        return service.updateTags(this.client.getHost(), resourceGroupName, ddosProtectionPlanName, apiVersion, this.client.getSubscriptionId(), parameters);
    }
    ...
    public Mono<Response<Void>> beginDeleteWithResponseAsync(String resourceGroupName, String ddosProtectionPlanName) {
        final String apiVersion = "2019-06-01";
        return service.beginDelete(this.client.getHost(), resourceGroupName, ddosProtectionPlanName, apiVersion, this.client.getSubscriptionId());
    }
    ...
    public Mono<SimpleResponse<DdosProtectionPlanInner>> beginCreateOrUpdateWithResponseAsync(String resourceGroupName, String ddosProtectionPlanName, DdosProtectionPlanInner parameters) {
        final String apiVersion = "2019-06-01";
        return service.beginCreateOrUpdate(this.client.getHost(), resourceGroupName, ddosProtectionPlanName, apiVersion, this.client.getSubscriptionId(), parameters);
    }
    ...
    public Mono<SimpleResponse<DdosProtectionPlanInner>> beginUpdateTagsWithResponseAsync(String resourceGroupName, String ddosProtectionPlanName, Map<String, String> tags) {
        ...
        TagsObject parameters = new TagsObject();
        parameters.withTags(tags);
        return service.beginUpdateTags(this.client.getHost(), resourceGroupName, ddosProtectionPlanName, apiVersion, this.client.getSubscriptionId(), parameters);
    }
