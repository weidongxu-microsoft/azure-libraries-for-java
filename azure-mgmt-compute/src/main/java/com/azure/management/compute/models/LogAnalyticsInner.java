...
public final class LogAnalyticsInner {
    ...
    private interface LogAnalyticsService {
        ...
        Mono<SimpleResponse<Flux<ByteBuffer>>> exportRequestRateByInterval(@HostParam("$host") String host, @PathParam("location") String location, @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId, @BodyParam("application/json") RequestRateByIntervalInput parameters);
        ...
        @ExpectedResponses({200, 202})
        @UnexpectedResponseExceptionType(CloudException.class)
        Mono<SimpleResponse<Flux<ByteBuffer>>> exportThrottledRequests(@HostParam("$host") String host, @PathParam("location") String location, @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId, @BodyParam("application/json") ThrottledRequestsInput parameters);

        @Headers({ "Accept: application/json", "Content-Type: application/json" })
        @Post("/subscriptions/{subscriptionId}/providers/Microsoft.Compute/locations/{location}/logAnalytics/apiAccess/getRequestRateByInterval")
        @ExpectedResponses({200, 202})
        @UnexpectedResponseExceptionType(CloudException.class)
        Mono<SimpleResponse<LogAnalyticsOperationResultInner>> beginExportRequestRateByInterval(@HostParam("$host") String host, @PathParam("location") String location, @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId, @BodyParam("application/json") RequestRateByIntervalInput parameters);

        @Headers({ "Accept: application/json", "Content-Type: application/json" })
        @Post("/subscriptions/{subscriptionId}/providers/Microsoft.Compute/locations/{location}/logAnalytics/apiAccess/getThrottledRequests")
        @ExpectedResponses({200, 202})
        @UnexpectedResponseExceptionType(CloudException.class)
        Mono<SimpleResponse<LogAnalyticsOperationResultInner>> beginExportThrottledRequests(@HostParam("$host") String host, @PathParam("location") String location, @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId, @BodyParam("application/json") ThrottledRequestsInput parameters);
    }
    ...
    public Mono<SimpleResponse<Flux<ByteBuffer>>> exportRequestRateByIntervalWithResponseAsync(String location, RequestRateByIntervalInput parameters) {
        ...
        return service.exportRequestRateByInterval(this.client.getHost(), location, apiVersion, this.client.getSubscriptionId(), parameters);
    }
    ...
    public Mono<SimpleResponse<Flux<ByteBuffer>>> exportThrottledRequestsWithResponseAsync(String location, ThrottledRequestsInput parameters) {
        final String apiVersion = "2019-03-01";
        return service.exportThrottledRequests(this.client.getHost(), location, apiVersion, this.client.getSubscriptionId(), parameters);
    }
    ...
    public Mono<SimpleResponse<LogAnalyticsOperationResultInner>> beginExportRequestRateByIntervalWithResponseAsync(String location, RequestRateByIntervalInput parameters) {
        final String apiVersion = "2019-03-01";
        return service.beginExportRequestRateByInterval(this.client.getHost(), location, apiVersion, this.client.getSubscriptionId(), parameters);
    }
    ...
    public Mono<SimpleResponse<LogAnalyticsOperationResultInner>> beginExportThrottledRequestsWithResponseAsync(String location, ThrottledRequestsInput parameters) {
        final String apiVersion = "2019-03-01";
        return service.beginExportThrottledRequests(this.client.getHost(), location, apiVersion, this.client.getSubscriptionId(), parameters);
    }
