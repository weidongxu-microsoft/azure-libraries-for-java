...
import com.azure.management.appservice.SiteExtensionType;
...
public class SiteExtensionInfoInner extends ProxyOnlyResource {
    ...
    /**
     * Get the installerCommandLineParams property: Installer command line
     * parameters.
     * 
    ...
    /**
     * Set the installerCommandLineParams property: Installer command line
     * parameters.
     * 
     * @param installerCommandLineParams the installerCommandLineParams value
     * to set.
     * @return the SiteExtensionInfoInner object itself.
     */
    ...
    /**
     * Get the localIsLatestVersion property: &lt;code&gt;true&lt;/code&gt; if
     * the local version is the latest version; &lt;code&gt;false&lt;/code&gt;
     * otherwise.
     * 
    ...
    /**
     * Set the localIsLatestVersion property: &lt;code&gt;true&lt;/code&gt; if
     * the local version is the latest version; &lt;code&gt;false&lt;/code&gt;
     * otherwise.
     * 
