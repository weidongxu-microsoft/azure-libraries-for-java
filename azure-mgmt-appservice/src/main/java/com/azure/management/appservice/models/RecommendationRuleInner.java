...
public class RecommendationRuleInner extends ProxyOnlyResource {
    ...
    /**
     * Get the recommendationId property: Recommendation ID of an associated
    ...
    /**
     * Set the recommendationId property: Recommendation ID of an associated
     * recommendation object tied to the rule, if exists.
     * If such an object doesn't exist, it is set to null.
     * 
    ...
    /**
     * Get the description property: Localized detailed description of the
     * rule.
     * 
    ...
    /**
     * Set the description property: Localized detailed description of the
     * rule.
     * 
    ...
    /**
     * Get the actionName property: Name of action that is recommended by this
     * rule in string.
     * 
    ...
    /**
     * Set the actionName property: Name of action that is recommended by this
     * rule in string.
     * 
