...
public final class SkuDescription {
    ...
    /**
     * Get the capacity property: Current number of instances assigned to the
     * resource.
     * 
    ...
    /**
     * Set the capacity property: Current number of instances assigned to the
     * resource.
     * 
    ...
    /**
     * Get the capabilities property: Capabilities of the SKU, e.g., is traffic
     * manager enabled?.
     * 
    ...
    /**
     * Set the capabilities property: Capabilities of the SKU, e.g., is traffic
     * manager enabled?.
     * 
