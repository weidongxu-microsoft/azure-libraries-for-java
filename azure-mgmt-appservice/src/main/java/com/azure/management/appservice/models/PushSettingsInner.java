...
public class PushSettingsInner extends ProxyOnlyResource {
    ...
    /**
     * Get the isPushEnabled property: Gets or sets a flag indicating whether
    ...
    /**
     * Set the isPushEnabled property: Gets or sets a flag indicating whether
     * the Push endpoint is enabled.
     * 
    ...
    /**
     * Get the tagWhitelistJson property: Gets or sets a JSON string containing
    ...
    /**
     * Set the tagWhitelistJson property: Gets or sets a JSON string containing
     * a list of tags that are whitelisted for use by the push registration
     * endpoint.
     * 
    ...
    /**
     * Get the tagsRequiringAuth property: Gets or sets a JSON string
    ...
    /**
     * Set the tagsRequiringAuth property: Gets or sets a JSON string
     * containing a list of tags that require user authentication to be used in
     * the push registration endpoint.
     * Tags can consist of alphanumeric characters and the following:
     * '_', '@', '#', '.', ':', '-'.
    ...
    /**
     * Get the dynamicTagsJson property: Gets or sets a JSON string containing
     * a list of dynamic tags that will be evaluated from user claims in the
    ...
    /**
     * Set the dynamicTagsJson property: Gets or sets a JSON string containing
     * a list of dynamic tags that will be evaluated from user claims in the
     * push registration endpoint.
     * 
