...
public class SlotDifferenceInner extends ProxyOnlyResource {
    ...
    /**
     * Get the level property: Level of the difference: Information, Warning or
     * Error.
     * 
    ...
    /**
     * Get the settingType property: The type of the setting: General,
    ...
    /**
     * Get the diffRule property: Rule that describes how to process the
    ...
    /**
     * Get the valueInCurrentSlot property: Value of the setting in the current
     * slot.
     * 
    ...
    /**
     * Get the valueInTargetSlot property: Value of the setting in the target
     * slot.
     * 
