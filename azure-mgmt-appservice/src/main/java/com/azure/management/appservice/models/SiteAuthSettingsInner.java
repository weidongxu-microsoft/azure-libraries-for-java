...
public class SiteAuthSettingsInner extends ProxyOnlyResource {
    ...
    /**
     * Get the enabled property: &lt;code&gt;true&lt;/code&gt; if the
    ...
    /**
     * Set the enabled property: &lt;code&gt;true&lt;/code&gt; if the
     * Authentication / Authorization feature is enabled for the current app;
     * otherwise, &lt;code&gt;false&lt;/code&gt;.
     * 
    ...
    /**
     * Get the runtimeVersion property: The RuntimeVersion of the
    ...
    /**
     * Set the runtimeVersion property: The RuntimeVersion of the
     * Authentication / Authorization feature in use for the current app.
     * The setting in this value can control the behavior of certain features
     * in the Authentication / Authorization module.
     * 
    ...
    /**
     * Get the unauthenticatedClientAction property: The action to take when an
    ...
    /**
     * Set the unauthenticatedClientAction property: The action to take when an
     * unauthenticated client attempts to access the app.
     * 
     * @param unauthenticatedClientAction the unauthenticatedClientAction value
     * to set.
     * @return the SiteAuthSettingsInner object itself.
     */
    ...
    /**
     * Get the tokenStoreEnabled property: &lt;code&gt;true&lt;/code&gt; to
    ...
    /**
     * Set the tokenStoreEnabled property: &lt;code&gt;true&lt;/code&gt; to
     * durably store platform-specific security tokens that are obtained during
     * login flows; otherwise, &lt;code&gt;false&lt;/code&gt;.
     * The default is &lt;code&gt;false&lt;/code&gt;.
     * 
    ...
    /**
     * Get the allowedExternalRedirectUrls property: External URLs that can be
    ...
    /**
     * Set the allowedExternalRedirectUrls property: External URLs that can be
     * redirected to as part of logging in or logging out of the app. Note that
     * the query string part of the URL is ignored.
     * This is an advanced setting typically only needed by Windows Store
     * application backends.
     * Note that URLs within the current domain are always implicitly allowed.
     * 
     * @param allowedExternalRedirectUrls the allowedExternalRedirectUrls value
     * to set.
     * @return the SiteAuthSettingsInner object itself.
     */
    ...
    /**
     * Get the defaultProvider property: The default authentication provider to
    ...
    /**
     * Set the defaultProvider property: The default authentication provider to
     * use when multiple providers are configured.
     * This setting is only needed if multiple providers are configured and the
     * unauthenticated client
     * action is set to "RedirectToLoginPage".
    ...
    /**
     * Get the tokenRefreshExtensionHours property: The number of hours after
    ...
    /**
     * Set the tokenRefreshExtensionHours property: The number of hours after
     * session token expiration that a session token can be used to
     * call the token refresh API. The default is 72 hours.
     * 
     * @param tokenRefreshExtensionHours the tokenRefreshExtensionHours value
     * to set.
     * @return the SiteAuthSettingsInner object itself.
     */
    ...
    /**
     * Get the clientId property: The Client ID of this relying party
    ...
    /**
     * Set the clientId property: The Client ID of this relying party
     * application, known as the client_id.
     * This setting is required for enabling OpenID Connection authentication
     * with Azure Active Directory or
     * other 3rd party OpenID Connect providers.
    ...
    /**
     * Get the clientSecret property: The Client Secret of this relying party
    ...
    /**
     * Set the clientSecret property: The Client Secret of this relying party
     * application (in Azure Active Directory, this is also referred to as the
     * Key).
     * This setting is optional. If no client secret is configured, the OpenID
     * Connect implicit auth flow is used to authenticate end users.
    ...
    /**
     * Get the clientSecretCertificateThumbprint property: An alternative to
    ...
    /**
     * Set the clientSecretCertificateThumbprint property: An alternative to
     * the client secret, that is the thumbprint of a certificate used for
     * signing purposes. This property acts as
     * a replacement for the Client Secret. It is also optional.
     * 
     * @param clientSecretCertificateThumbprint the
     * clientSecretCertificateThumbprint value to set.
     * @return the SiteAuthSettingsInner object itself.
     */
    ...
    /**
     * Get the issuer property: The OpenID Connect Issuer URI that represents
    ...
    /**
     * Set the issuer property: The OpenID Connect Issuer URI that represents
     * the entity which issues access tokens for this application.
     * When using Azure Active Directory, this value is the URI of the
     * directory tenant, e.g. https://sts.windows.net/{tenant-guid}/.
     * This URI is a case-sensitive identifier for the token issuer.
    ...
    /**
     * Get the validateIssuer property: Gets a value indicating whether the
    ...
    /**
     * Set the validateIssuer property: Gets a value indicating whether the
     * issuer should be a valid HTTPS url and be validated as such.
     * 
    ...
    /**
     * Get the allowedAudiences property: Allowed audience values to consider
    ...
    /**
     * Set the allowedAudiences property: Allowed audience values to consider
     * when validating JWTs issued by
     * Azure Active Directory. Note that the &lt;code&gt;ClientID&lt;/code&gt;
     * value is always considered an
     * allowed audience, regardless of this setting.
    ...
    /**
     * Get the additionalLoginParams property: Login parameters to send to the
    ...
    /**
     * Set the additionalLoginParams property: Login parameters to send to the
     * OpenID Connect authorization endpoint when
     * a user logs in. Each parameter must be in the form "key=value".
     * 
    ...
    /**
     * Get the googleClientId property: The OpenID Connect Client ID for the
    ...
    /**
     * Set the googleClientId property: The OpenID Connect Client ID for the
     * Google web application.
     * This setting is required for enabling Google Sign-In.
     * Google Sign-In documentation:
     * https://developers.google.com/identity/sign-in/web/.
    ...
    /**
     * Get the googleClientSecret property: The client secret associated with
    ...
    /**
     * Set the googleClientSecret property: The client secret associated with
     * the Google web application.
     * This setting is required for enabling Google Sign-In.
     * Google Sign-In documentation:
     * https://developers.google.com/identity/sign-in/web/.
    ...
    /**
     * Get the googleOAuthScopes property: The OAuth 2.0 scopes that will be
    ...
    /**
     * Set the googleOAuthScopes property: The OAuth 2.0 scopes that will be
     * requested as part of Google Sign-In authentication.
     * This setting is optional. If not specified, "openid", "profile", and
     * "email" are used as default scopes.
     * Google Sign-In documentation:
    ...
    /**
     * Get the facebookAppId property: The App ID of the Facebook app used for
     * login.
     * This setting is required for enabling Facebook Login.
     * Facebook Login documentation:
     * https://developers.facebook.com/docs/facebook-login.
    ...
    /**
     * Set the facebookAppId property: The App ID of the Facebook app used for
     * login.
     * This setting is required for enabling Facebook Login.
     * Facebook Login documentation:
     * https://developers.facebook.com/docs/facebook-login.
    ...
    /**
     * Get the facebookAppSecret property: The App Secret of the Facebook app
    ...
    /**
     * Set the facebookAppSecret property: The App Secret of the Facebook app
     * used for Facebook Login.
     * This setting is required for enabling Facebook Login.
     * Facebook Login documentation:
     * https://developers.facebook.com/docs/facebook-login.
    ...
    /**
     * Get the facebookOAuthScopes property: The OAuth 2.0 scopes that will be
    ...
    /**
     * Set the facebookOAuthScopes property: The OAuth 2.0 scopes that will be
     * requested as part of Facebook Login authentication.
     * This setting is optional.
     * Facebook Login documentation:
     * https://developers.facebook.com/docs/facebook-login.
    ...
    /**
     * Get the twitterConsumerKey property: The OAuth 1.0a consumer key of the
    ...
    /**
     * Set the twitterConsumerKey property: The OAuth 1.0a consumer key of the
     * Twitter application used for sign-in.
     * This setting is required for enabling Twitter Sign-In.
     * Twitter Sign-In documentation: https://dev.twitter.com/web/sign-in.
     * 
    ...
    /**
     * Get the twitterConsumerSecret property: The OAuth 1.0a consumer secret
    ...
    /**
     * Set the twitterConsumerSecret property: The OAuth 1.0a consumer secret
     * of the Twitter application used for sign-in.
     * This setting is required for enabling Twitter Sign-In.
     * Twitter Sign-In documentation: https://dev.twitter.com/web/sign-in.
     * 
    ...
    /**
     * Get the microsoftAccountClientId property: The OAuth 2.0 client ID that
    ...
    /**
     * Set the microsoftAccountClientId property: The OAuth 2.0 client ID that
     * was created for the app used for authentication.
     * This setting is required for enabling Microsoft Account authentication.
     * Microsoft Account OAuth documentation:
     * https://dev.onedrive.com/auth/msa_oauth.htm.
     * 
     * @param microsoftAccountClientId the microsoftAccountClientId value to
     * set.
     * @return the SiteAuthSettingsInner object itself.
     */
    ...
    /**
     * Get the microsoftAccountClientSecret property: The OAuth 2.0 client
    ...
    /**
     * Set the microsoftAccountClientSecret property: The OAuth 2.0 client
     * secret that was created for the app used for authentication.
     * This setting is required for enabling Microsoft Account authentication.
     * Microsoft Account OAuth documentation:
     * https://dev.onedrive.com/auth/msa_oauth.htm.
     * 
     * @param microsoftAccountClientSecret the microsoftAccountClientSecret
     * value to set.
     * @return the SiteAuthSettingsInner object itself.
     */
    ...
    /**
     * Get the microsoftAccountOAuthScopes property: The OAuth 2.0 scopes that
    ...
    /**
     * Set the microsoftAccountOAuthScopes property: The OAuth 2.0 scopes that
     * will be requested as part of Microsoft Account authentication.
     * This setting is optional. If not specified, "wl.basic" is used as the
     * default scope.
     * Microsoft Account Scopes and permissions documentation:
     * https://msdn.microsoft.com/en-us/library/dn631845.aspx.
     * 
     * @param microsoftAccountOAuthScopes the microsoftAccountOAuthScopes value
     * to set.
     * @return the SiteAuthSettingsInner object itself.
     */
