...
public class HybridConnectionInner extends ProxyOnlyResource {
    ...
    /**
     * Get the serviceBusNamespace property: The name of the Service Bus
     * namespace.
     * 
    ...
    /**
     * Set the serviceBusNamespace property: The name of the Service Bus
     * namespace.
     * 
    ...
    /**
     * Get the sendKeyName property: The name of the Service Bus key which has
    ...
    /**
     * Set the sendKeyName property: The name of the Service Bus key which has
     * Send permissions. This is used to authenticate to Service Bus.
     * 
    ...
    /**
     * Get the sendKeyValue property: The value of the Service Bus key. This is
     * used to authenticate to Service Bus. In ARM this key will not be
     * returned
     * normally, use the POST /listKeys API instead.
     * 
    ...
    /**
     * Set the sendKeyValue property: The value of the Service Bus key. This is
     * used to authenticate to Service Bus. In ARM this key will not be
     * returned
     * normally, use the POST /listKeys API instead.
     * 
    ...
    /**
     * Get the serviceBusSuffix property: The suffix for the service bus
