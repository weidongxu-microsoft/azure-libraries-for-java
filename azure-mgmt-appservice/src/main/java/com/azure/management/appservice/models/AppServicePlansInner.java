...
public final class AppServicePlansInner implements InnerSupportsGet<AppServicePlanInner>, InnerSupportsListing<AppServicePlanInner>, InnerSupportsDelete<Void> {
    ...
    public Mono<AppServicePlanInner> createOrUpdateAsync(String resourceGroupName, String name, AppServicePlanInner appServicePlan) {
        ...
        return this.client.<AppServicePlanInner, AppServicePlanInner>getLroResultAsync(response, this.client.getHttpPipeline(), AppServicePlanInner.class, AppServicePlanInner.class)
            .last()
