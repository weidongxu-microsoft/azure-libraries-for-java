...
public class FunctionEnvelopeInner extends ProxyOnlyResource {
    ...
    /**
     * Get the testData property: Test data used when testing via the Azure
     * Portal.
     * 
    ...
    /**
     * Set the testData property: Test data used when testing via the Azure
     * Portal.
     * 
    ...
    /**
     * Get the isDisabled property: Gets or sets a value indicating whether the
    ...
    /**
     * Set the isDisabled property: Gets or sets a value indicating whether the
     * function is disabled.
     * 
