...
public final class ResourceManagementClientImpl extends AzureServiceClient {
     ...
     */
    ResourceManagementClientImpl setSubscriptionId(String subscriptionId) {
     ...
     * @return the service client itself.
     */
    ResourceManagementClientImpl setHost(String host) {
        this.host = host;
        return this;
    }
     ...
     * @return the service client itself.
     */
    ResourceManagementClientImpl setApiVersion(String apiVersion) {
