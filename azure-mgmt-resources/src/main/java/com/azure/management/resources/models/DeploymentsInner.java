...
public final class DeploymentsInner implements InnerSupportsGet<DeploymentExtendedInner>, InnerSupportsListing<DeploymentExtendedInner>, InnerSupportsDelete<Void> {
    ...
    public Mono<DeploymentExtendedInner> createOrUpdateAtScopeAsync(String scope, String deploymentName, DeploymentInner parameters) {
        ...
        return this.client.<DeploymentExtendedInner, DeploymentExtendedInner>getLroResultAsync(response, this.client.getHttpPipeline(), DeploymentExtendedInner.class, DeploymentExtendedInner.class)
            .last()
            .flatMap(AsyncPollResponse::getFinalResult);
    }
    ...
    public Mono<WhatIfOperationResultInner> whatIfAtSubscriptionScopeAsync(String deploymentName, DeploymentWhatIf parameters) {
        ...
        return this.client.<WhatIfOperationResultInner, WhatIfOperationResultInner>getLroResultAsync(response, this.client.getHttpPipeline(), WhatIfOperationResultInner.class, WhatIfOperationResultInner.class)
            .last()
            .flatMap(AsyncPollResponse::getFinalResult);
    }
    ...
    public Mono<PagedResponse<DeploymentExtendedInner>> listSinglePageAsync(String filter, Integer top) {
        return service.list(this.client.getHost(), filter, top, this.client.getApiVersion(), this.client.getSubscriptionId()).map(res -> new PagedResponseBase<>(
            res.getRequest(),
            res.getStatusCode(),
            res.getHeaders(),
            res.getValue().getValue(),
    ...
    public Mono<PagedResponse<DeploymentExtendedInner>> listByResourceGroupSinglePageAsync(String resourceGroupName, String filter, Integer top) {
        return service.listByResourceGroup(this.client.getHost(), resourceGroupName, filter, top, this.client.getApiVersion(), this.client.getSubscriptionId()).map(res -> new PagedResponseBase<>(
            res.getRequest(),
            res.getStatusCode(),
            res.getHeaders(),
            res.getValue().getValue(),
